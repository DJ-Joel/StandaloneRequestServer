...
if ($streamId > 0)
{
	...
	// original key.
	echo "<form method=get action=submitreq-run.php><input type=hidden name=screensize value=$screensize><input type=hidden name=stream_id value=$streamId>Please enter your name or nickname:<br><input type=text name=singer autocomplete=off autofocus><br>";
