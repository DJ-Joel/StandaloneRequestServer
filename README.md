...
+ Singers can create accounts and save favorite songs
+ Singers can request key changes when submitting requests


Phase 1:  Making your Windows based computer a web server for your home or venue:
...
Create a folder and name it requests    (all lower case letters)
Unzip the OpenKJ Standalone Request Server into the requests folder
...
Start OpenKJ
Click on KARAOKE  >> INCOMING REQUESTS
Click on UODATE REMOTE DB
Check the box to Allow Requests

If you would like to change the name of your Karaoke Venue Name you can open settings.ini in the requests folder with Notepad and make the change
